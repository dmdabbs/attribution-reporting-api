...
We also introduce a debugging framework to allow developers to monitor certain [failures](https://github.com/WICG/attribution-reporting-api/blob/main/verbose_debugging_reports.md) in the attribution registrations.
